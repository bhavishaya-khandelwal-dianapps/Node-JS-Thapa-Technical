...
//* What is Node JS ?
//*=======================================
//? It is open source, server-side JavaScript Runtime.

//? Allows you to run JavaScript on your machine or servers. 

//? Built on the V8 JavaScript for speed.
...
//* In browers : JavaScript typically runs in the browser (like Chrome or FireFox) to handle frontend tasks. 

//? With Node.js :- 
//* Node.js allows JS to run outside the browser, on the server. 
//? It provides tools to interact with the system, like : 
    //! File System (read, write files) 
    //! Network (handle HTTP files) 
...
//*=======================================
//? V8 Engine :
    //* Node.js uses Google Chrome's V8 engine to compile JavaScript into machine code, making it lighting-fast. 

//? Built-in APIs : 
    //* Node.js comes with built-in APIs (like fs for file systems or http for server) so you can build powerful applications without extra libraries. 
